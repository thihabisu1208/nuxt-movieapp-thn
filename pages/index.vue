...
export default {
  ...
  methods: {
    async getMovies() {
      const data = axios.get("https://api.themoviedb.org/3/movie/now_playing?api_key=1709d71069424cbd7a423023fdd4c3ba&language=en-US&page=1");
    ...
    async searchMovies() {
      const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=1709d71069424cbd7a423023fdd4c3ba&language=en-US&page=1&query=${this.searchInput}`);
      const result = await data;
      result.data.results.forEach(movie => {
